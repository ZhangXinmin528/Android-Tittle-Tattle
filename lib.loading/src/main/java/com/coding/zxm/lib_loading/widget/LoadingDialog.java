package com.coding.zxm.lib_loading.widget;
...
public class LoadingDialog extends Dialog {
    ...
    public static final class Builder {
        ...
        public Builder(@NonNull Context context, @NonNull View rootView) {
            this(context, R.style.Theme_LoadingDialog, rootView);
        }

        public Builder(@NonNull Context context, @LayoutRes int layoutResID) {
            this(context, R.style.Theme_LoadingDialog, layoutResID);
        }
         ...
         */
        public LoadingDialog create(@IntRange(from = 0) int width, @IntRange(from = 0) int height) {
        ...
        /**
         * Start the dialog and display it on screen.{@link LoadingDialog#show()}
         *
         * @param width
         * @param height
         */
        public LoadingDialog display(@IntRange(from = 0) int width, @IntRange(from = 0) int height) {
            return display(width, height, -1);
        }
         ...
         */
        public LoadingDialog display(@IntRange(from = 0) int width, @IntRange(from = 0) int height, int gravity) {
            final LoadingDialog dialog = create(width, height);
            dialog.show();
        ...
        private void setUpView(@NonNull final LoadingDialog dialog, int width, int height) {
            if (P.mRootView == null) {
                if (P.layoutResID != 0) {
            ...
            P.mHeight = ScreenUtil.dp2px(dialog.getContext(), height);
            //Message
